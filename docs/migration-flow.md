...
- **📝 Create PR**: Always create pull request targeting the current workflow branch with detailed migration information for review and validation by repository CI/CD
...
- **Always creates PRs**: All successful migrations result in PR creation targeting the current workflow branch for proper review and CI validation
